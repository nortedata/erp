        ...
        <div class="pl-lg-4">
            ...
            <div class="ms">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-6">
                        <h5>
                            Código de rastreamento: <strong class="text-danger">{{ $item->codigo_rastreamento }}</strong>
                            <a href="#!" data-bs-toggle="modal" data-bs-target="#modal-codigo-rastreamento">
                                Editar
                            </a>
                        </h5>
                ...
                <div class="table-responsive-sm">
                    <table class="table table-striped table-centered mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $i->produto ? $i->produto->nome : $i->item_nome }}</td>
...
<div class="modal fade" id="modal-codigo-rastreamento" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="{{ route('mercado-livre-pedidos.update', [$item->id]) }}">
                @csrf
                @method('put')
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Alterar Código</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
