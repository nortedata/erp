<div class="modal fade" id="sangria_caixa" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-6 mt-3">
                        {!! Form::tel('valor', 'Total em Dinheiro')->attrs(['class' => 'moeda']) !!}
                    </div>
