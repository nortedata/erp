    ...
    <div class="row">
        <div class="card">
            <div class="card-body">
                ...
                <h3>Inserir Código de Identificação Única de Produtos Venda</h3>
                {!!Form::open()
                ->post()
                ->route('nfe.setar-codigo-unico')
                !!}

                <input type="hidden" value="{{ $item->id }}" name="nfe_id">
                        ...
                        <table class="table table-striped table-centered mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control codigo_unico" name="codigo[]">
                                        </select>
                                    </td>
                                    <td>
