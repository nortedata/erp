        ...
        <div class="pl-lg-4">
            ...
            <div class="ms">
                ...
                <div class="mt-3 d-print-none" style="text-align: right;">
                    <a href="{{ route('woocommerce-pedidos.index') }}" class="btn btn-danger btn-sm px-3">
                ...
                @if($item->nfe_id == 0)
                <a class="btn btn-success btn-sm d-print-none" href="{{ route('woocommerce-pedidos.gerar-nfe', $item->id) }}">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-6 col-12">
                    <h4>Documento do Cliente: <strong>{{ $item->cliente->cpf_cnpj }}</strong></h4>
